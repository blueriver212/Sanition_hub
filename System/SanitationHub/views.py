...
from chartjs.views.lines import BaseLineChartView #> CMD does not accept chartjs.views.lines, so have imported the module from .chartjs below
#from .chartjs import BaseLineChartView
